...
# @app.route('/fraudperson', methods=['POST', 'GET'])
# def fraudperson():  # put application's code here
#     data = [
#         {'id': 1, 'account': "123", 'factor': "0.9"},
#         {'id': 2, 'account': "456", 'factor': "0.5"},
#         {'id': 3, 'account': "789", 'factor': "0.1"},
#         {'id': 4, 'account': "789", 'factor': "0.1"},
#         {'id': 5, 'account': "789", 'factor': "0.1"},
#         {'id': 6, 'account': "789", 'factor': "0.1"},
#     ]
#     if request.method == 'POST':
#         print('post')
#     if request.method == 'GET':
#         info = request.values
#         limit = info.get('limit', 6)  # 每页显示的条数
